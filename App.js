    ...
    return(
         ...
         <Toaster toastOptions={{ duration: 4000 }} />
            ...
            Right OTP
                ...
                <label htmlFor="" className="font-bold text-2xl text-white text-center">
                   Verify Your Phone Number
                </label>
                <PhoneInput country={"bd"} value={ph} onChange={setPh}/>
                 <button 
                 onClick={onSignup}
                 className="font-bold bg-emerald-600 w-full flex gap-1 items-center  justify-center py-2 text-white rounded"
                 >
                    {
                    loading &&
                    <CgSpinner size={20} className="mt-1 animate-spin"/>
